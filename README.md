...
|---|---|---|
| **Ctrl+Shift+C** | Rapide | Corrige tout automatiquement, prend toujours la meilleure suggestion, aucune interruption |
...
2. Appuie sur **Ctrl+Shift+C** (rapide) ou **Ctrl+Alt+C** (avec choix).
...
^+c::CorrigerSelection(false)   ; Ctrl+Shift+C = mode rapide
